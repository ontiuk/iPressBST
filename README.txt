...
iPressBST is a Standalone Theme framework based on the iPress Rapid Development Theme Framework for WordPress. 
...
| 			|-container-close.php
| 			|-site-branding.php
| 			|-site-branding-logo.php
| 			|-site-branding-wrap.php
| 			|-site-navigation.php
| 	|-/layout
| 	|-/loop
| 		|-content.php
