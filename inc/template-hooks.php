...
/**
 * @see ipress_sidebar_header()
 */
add_action( 'ipress_before_content', 'ipress_sidebar_header', 10 );
 ...
 * @see  ipress_site_navigation_top()
 */
add_action( 'ipress_header', 'ipress_primary_navigation', 10 );
add_action( 'ipress_site_navigation_top', 'ipress_site_branding', 10 );
